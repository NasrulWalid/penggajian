    ...
    <body>
        ...
        <table class="table table-striped table-bordered mt-3">
            ...
            <tr>
                ...
                <td>Rp. <?php echo number_format($ps->tunjangan_transport,0,',','.') ?></td>
            </tr>
            <tr>
                <td>3</td>
                <td>Uang Makan</td>
            ...
            <tr>
                ...
                <th>Rp. <?php echo number_format($ps->gaji_pokok+$ps->tunjangan_transport+$ps->uang_makan-$potongan_gaji,0,',','.') ?></th>
            </tr>
        </table>
        <table width="100%">
            <tr>
