<div class="container-fluid">
	...
	<a class="btn btn-sm btn-success mb-2 mt-2" href="<?php echo base_url('admin/potonganGaji/tambah_data') ?>"><i class="fas fa-plus"></i> Tambah Data</a>
	...
	<table class="table table-bordered table-striped">
		...
		<tr>
			...
			<td>
				<center>
					<a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/potonganGaji/update_data/'.$p->id) ?>"><i class="fas fa-edit"></i></a>
